...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens26_170_10_ft5_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens26",
                "model_version": "13.26",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens26",
                "repo_commit": git_commit,
                "notes": "Gen13Tens26 neural network scorer (POT=170, AAF=10, ft5)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        synapse.predictions = [s >= 0.0007 for s in scores]
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml13tens26.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml13tens26"
            )
            time.sleep(60)
